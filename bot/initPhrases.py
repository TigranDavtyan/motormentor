...
insertPhrase('choose_car_year',
    'Խնդրում ենք մուտքագրել ձեր մեքենայի արտադրության տարեթիվը, օրինակ՝ «2018»:',
    'Пожалуйста, введите год выпуска вашего автомобиля, например "2018".',
    'Please enter the manufacturing year of your car, for example "2018".')
insertPhrase('choose_car_mileage',
    'Խնդրում ենք մուտքագրել ձեր մեքենայի վազքը, օրինակ՝ «68000»:',
    'Пожалуйста, введите пробег вашего автомобиля, например "68000".',
    'Please enter the mileage of your car, for example "68000".')
insertPhrase('choose_car_engine_size',       
    'Խնդրում ենք մուտքագրել ձեր մեքենայի շարժիչի չափը, օրինակ՝ «2.5»:',
    'Пожалуйста, введите объем двигателя вашего автомобиля, например "2,5".',
...
insertPhrase('choose_car_wheel_size',
    'Խնդրում ենք մուտքագրել ձեր մեքենայի անիվի չափը, օրինակ՝ «16»:',
    'Пожалуйста, введите размер колес вашего автомобиля, например "16".',
